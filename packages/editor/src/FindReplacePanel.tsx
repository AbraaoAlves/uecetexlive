...
export interface FindReplacePanelProps {
  ...
  onClose: () => void;
  /**
   * Copy explícita — só necessária quando o painel renderiza fora da árvore
   * React do provider (ex.: painel do CodeMirror, que vive em outro root).
   */
...
export function FindReplacePanel({
  ...
  const contextStrings = useEditorStrings();
  const strings = stringsProp ?? contextStrings;
