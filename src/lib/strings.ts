...
export const strings = {
  ...
  references: {
    ...
    removeFromEdit: "Remover referência",
    editUnsupportedType:
    ...
    focusedAnnouncement: "Referência {key} selecionada para revisão.",
  ...
  compliance: {
    ...
    gotoItem: "ir para",
    reviewReference: "revisar referência",
    searchReference: "buscar referência",
    ...
    uncitedEntriesHelp:
      "Se ela faz parte do trabalho, cite-a no texto; caso contrário, remova-a das referências.",
